"""^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^
In this module we can run various tests in order to compare the string matching algorithms given in the match.py module.
^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^"""
import match as m
import random as r
...
# ------------------------------------------------------------------------------------------------------------------- #
# Here we select the file to open (file_in) and the word to match (pattern). We can also create a file with the
# previous function.
# ------------------------------------------------------------------------------------------------------------------- #
